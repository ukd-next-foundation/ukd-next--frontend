          ...
          <section className="personal_info">
            ...
            <div className="info_group">
              <div className={cls.info_item}>
                ...
                <ClipBoard value={"stanislav.zubko@ukd.edu.ua"}>
            ...
            <div className="info_group">
              <Link to={"/home/payment"}>
                <div className={cls.info_item}>
                  ...
                  <img src="/black_arrow.svg" alt="Arrow" />
                </div>
              </Link>
              <div className={`${cls.info_item} ${cls.roles}`}>
                <img src="/role_1.svg" alt="Application details icon" />
                <p className={cls.check_title}>Змінити роль </p>
                <img src="/black_arrow.svg" alt="Arrow" />
              </div>
            </div>
          </section>
